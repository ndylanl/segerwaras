   ...
   <nav class="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full top-0 left-0 border-b border-gray-200 dark:border-gray-600 z-50">
      <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="flex md:order-2">
            <button type="button" class="text-white bg-green-400 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                Login
            </button>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="/" class="block py-2 pl-3 pr-4 text-white bg-green-700 rounded md:bg-transparent md:text-green-700 md:p-0 dark:text-white" aria-current="page">
                        BERANDA
                    </a>
                </li>
                <li>
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 px-4 lg:pl-8">
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <a href="https://tailwindcss.com/" class="hover:underline">Berita</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <form action="" class="flex">
                                ...
                                <button class="border border-gray-500 px-3 -ml-[1px] hover:ring-2 hover:ring-green-500">-></button>
                            </form>
                        </li>
                    </ul>
                </div>
